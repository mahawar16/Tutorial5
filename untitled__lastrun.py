...
expName = 'untitled_'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\hp\\Desktop\\PSY310 LAB IN PSYCH\\TUT_5\\untitled__lastrun.py',
...
trials = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('C:/Users/hp/Desktop/PSY310 LAB IN PSYCH/TUT_5/study_word_file.xlsx'),
...
trials_2 = data.TrialHandler(nReps=1.0, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('C:/Users/hp/Desktop/PSY310 LAB IN PSYCH/TUT_5/test_word_fragment.xlsx'),
